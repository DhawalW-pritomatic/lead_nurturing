...
router.post('/:id/clone', authorize('tenant_admin', 'sales_manager', 'super_admin'), controller.clone.bind(controller));
...
router.patch('/enrollments/:id/unenroll', controller.unenrollLead.bind(controller));
